...
module EasybillRestClient
  class ContactApi
    ...
    def customers_customer_id_contacts_get_with_http_info(customer_id, opts = {})
      ...
      # resource path
      local_var_path = "/customers/{customerId}/contacts".sub('{format}','json').sub('{' + 'customerId' + '}', customer_id.to_s)
    ...
    def customers_customer_id_contacts_id_delete_with_http_info(customer_id, id, opts = {})
      ...
      # resource path
      local_var_path = "/customers/{customerId}/contacts/{id}".sub('{format}','json').sub('{' + 'customerId' + '}', customer_id.to_s).sub('{' + 'id' + '}', id.to_s)
