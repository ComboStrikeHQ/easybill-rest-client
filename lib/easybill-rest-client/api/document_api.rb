...
module EasybillRestClient
  class DocumentApi
    ...
    def documents_get_with_http_info(opts = {})
      ...
      # resource path
      local_var_path = "/documents".sub('{format}','json')
    ...
    def documents_id_cancel_post_with_http_info(id, opts = {})
      ...
      # resource path
      local_var_path = "/documents/{id}/cancel".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def documents_id_delete_with_http_info(id, opts = {})
      ...
      # resource path
      local_var_path = "/documents/{id}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def documents_id_done_put_with_http_info(id, opts = {})
      ...
      # resource path
      local_var_path = "/documents/{id}/done".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def documents_id_pdf_get_with_http_info(id, opts = {})
      ...
      # resource path
      local_var_path = "/documents/{id}/pdf".sub('{format}','json').sub('{' + 'id' + '}', id.to_s)
    ...
    def documents_id_send_type_post_with_http_info(id, type, body, opts = {})
      ...
      # resource path
      local_var_path = "/documents/{id}/send/{type}".sub('{format}','json').sub('{' + 'id' + '}', id.to_s).sub('{' + 'type' + '}', type.to_s)
